package com.lsege.scoket.client;

import com.lsege.scoket.SocketApplicationTests;
import com.lsege.socket.SocketApplication;
import com.lsege.socket.common.JsonConverter;
import com.lsege.socket.model.LoginRequest;
...
public class SocketClient {
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        socket =
                IO.socket("http://127.0.0.1:8088/", options);
        socket
